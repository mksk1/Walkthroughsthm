...
Al ver su perfil, hay varias rutas por las que seguir, puedo ver sus posts, su reputación o sus hilos.

Pero al intentar verlos, no me deja. Pruebo a verlos logueado.

Una vez logueado vuelvo al perfil de Willis y veo sus posts.
Tan solo veo 1 de 2200, pero ya es algo.
...
En un post encuentro otra página /bugbountyHQ. Se supone que esta deshabilitada. 

Accedo a la página y veo su código.

Al inicio del body encuentro algo interesante.

    <form method="post" action="/reportPanel.php"> //aqui hay un enlace.
  


En el código de la pagina encuentro reportPanel.php. 

Accedo a esa página y es una tabla con las vulnerabilidades reportadas.
